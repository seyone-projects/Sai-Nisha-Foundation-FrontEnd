        ...
        <Box sx={{ mt: { xs: -4, md: -5 } }}>
            <Container><motion.div variants={anim.fadeUp} initial="hidden" whileInView="visible">
              <Box sx={{ background: "rgba(30, 41, 59, 0.4)", backdropFilter: "blur(4px)", borderRadius: 6, p: { xs: 4, md: 8 }, boxShadow: "0 40px 120px rgba(0,0,0,0.3)", border: `1px solid rgba(255,255,255,0.1)` }}>
                <H4Center color={navyText} mt={8}>Our  <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}>Vision</span></H4Center>
                <Typography color={navyText} mt={2} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)' ,fontFamily: "'Playfair Display', serif"}}>A world where <Box component="span" sx={{ color: gold, fontWeight: 700 }}>no mother or newborn</Box> loses life due to <Box component="span" sx={{ color: gold, fontWeight: 600 }}>delayed care</Box>, <Box component="span" sx={{ color: gold, fontWeight: 600 }}>financial hardship</Box>, or lack of <Box component="span" sx={{ color: gold, fontWeight: 700 }}>medical support</Box>.<br /><br />We envision a future where <Box component="span" sx={{ color: navyText, fontWeight: 600 }}>every individual</Box> has the opportunity to <Box component="span" sx={{ color: gold, fontWeight: 700 }}>thrive</Box> through <Box component="span" sx={{ color: gold, fontWeight: 600 }}>sustainable support</Box>, <Box component="span" sx={{ color: "coral", fontWeight: 600 }}>education</Box>, and <Box component="span" sx={{ color: gold, fontWeight: 700 }}>compassionate care</Box>.</Typography>
                <Divider sx={{ my: 4, borderColor: "rgba(255,255,255,0.2)" }} />
                <H4Center color={navyText} mt={8}>Our  <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}>Mission</span></H4Center>
                <Typography color={navyText} mt={2} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)', fontFamily: "'Playfair Display', serif" }}>We act <Box component="span" sx={{ color: gold, fontWeight: 700 }}>swiftly</Box>, <Box component="span" sx={{ color: gold, fontWeight: 700 }}>compassionately</Box>, and <Box component="span" sx={{ color: gold, fontWeight: 700 }}>responsibly</Box> to <Box component="span" sx={{ color: olive, fontWeight: 700 }}>save lives</Box>, <Box component="span" sx={{ color: olive, fontWeight: 600 }}>empower families</Box>, and create meaningful impact during the <Box component="span" sx={{ color: navyText, fontWeight: 700 }}>most critical moments</Box>.<br /><br />Our mission is to <Box component="span" sx={{ color: gold, fontWeight: 700 }}>empower underprivileged communities</Box> by providing <Box component="span" sx={{ color: olive, fontWeight: 600 }}>essential resources</Box>, fostering <Box component="span" sx={{ color: olive, fontWeight: 600 }}>self-reliance</Box>, and <Box component="span" sx={{ color: gold, fontWeight: 700 }}>bridging the gap</Box> between <Box component="span" sx={{ color: "#EF4444", fontWeight: 700 }}>crisis</Box> and <Box component="span" sx={{ color: "#22C55E", fontWeight: 700 }}>stability</Box> through <Box component="span" sx={{ color: navyText, fontWeight: 700 }}>dedicated social service</Box>.</Typography>
                 <Divider sx={{ my: 4, borderColor: "rgba(255,255,255,0.2)" }} />
               <H4Center color={navyText} mt={8}>Our  <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}>Imapact Focus</span></H4Center>
               ...
               <Box sx={{ textAlign: "center", p: { xs: 3, md: 4 }, borderRadius: 4, background: `linear-gradient(135deg, rgba(15, 23, 42, 0.6), rgba(30, 41, 59, 0.6))`, color: "#fff", position: "relative", overflow: "hidden", border: `1px solid ${gold}44` }}>
                ...
                </Box>  <Divider sx={{ my: 4, borderColor: "rgba(255,255,255,0.2)" }} /><H4Center color={navyText}>Get <span style={{ color: olive, fontFamily: "'Playfair Display', serif" }}>Involved</span></H4Center>
           ...
           <motion.div variants={anim.fadeUp} initial="hidden" whileInView="visible">
            <Box sx={{ maxWidth: 980, mt: 3, mx: "auto", px: { xs: 3, md: 8 }, py: { xs: 4, md: 8 }, borderRadius: 6, background: "rgba(30, 41, 59, 0.4)", backdropFilter: "blur(4px)", boxShadow: "0 50px 140px rgba(0,0,0,0.4)", border: `1px solid rgba(255,255,255,0.1)` }}>
              <Typography lineHeight={1.8} color={navyText} fontSize="1.1rem" sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)', fontFamily: "'Playfair Display', serif" }}>
                ...
                <H4Center color={navyText} mt={8}>Our  <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}>Roots</span></H4Center>
              ...
              <Typography color={navyText} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)',fontFamily: "'Playfair Display', serif"  }}>
                &bull; Established in <Box component="span" sx={{ fontWeight: 800, color: navyText, fontFamily: "'Playfair Display', serif" }}>2023</Box> by <Box component="span" sx={{ fontWeight: 800, color: gold, fontFamily: "'Playfair Display', serif" }}>Ganesh and his spouse</Box> to honor a <Box component="span" sx={{ fontWeight: 600, color: olive }}>deeply personal promise</Box>.<br />
                &bull; Named in loving memory of <Box component="span" sx={{ fontWeight: 800, color: gold, fontFamily: "'Playfair Display', serif" }}>Sai</Box> and <Box component="span" sx={{ fontWeight: 800, color: gold ,fontFamily: "'Playfair Display', serif"}}>Nisha</Box>.<br />
                &bull; Born from the pain of <Box component="span" sx={{ fontWeight: 600, color: "#EF4444", fontFamily: "'Playfair Display', serif" }}>losing a child</Box> due to <Box component="span" sx={{ fontWeight: 600, color: olive,fontFamily: "'Playfair Display', serif" }}>delayed hospital care</Box>.
              </Typography>
              <H4Center color={navyText} mt={8}>A Purpose<span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}>Forged Through Loss</span></H4Center>
              <Divider sx={{ my: 2, borderColor: "rgba(255,255,255,0.1)" }} />
              <Typography color={navyText} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)', fontFamily: "'Playfair Display', serif" }}>
                &bull; Strengthened following the <Box component="span" sx={{ color: "#EF4444", fontWeight: 600, fontFamily: "'Playfair Display', serif" }}>untimely loss</Box> of our founder.<br />
                &bull; Transforming <Box component="span" sx={{ color: gold, fontWeight: 800 , fontFamily: "'Playfair Display', serif"}}>personal grief</Box> into <Box component="span" sx={{ color: olive, fontWeight: 600 }}>compassionate action</Box>.<br />
             ...
             <H4Center color={navyText} mt={8}>What We<span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}> believe </span></H4Center>
              <Divider sx={{ my: 2, borderColor: "rgba(255,255,255,0.1)" }} />
              <Typography color={navyText} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)',fontFamily: "'Playfair Display', serif" }}>&bull; <Box component="span" sx={{ fontWeight: 800, color: gold, fontFamily: "'Playfair Display', serif" }}>Every mother</Box> deserves <Box component="span" sx={{ fontWeight: 600, color: olive }}>dignity and care</Box>.<br />&bull; <Box component="span" sx={{ fontWeight: 800, color: navyText }}>Timely intervention</Box> saves <Box component="span" sx={{ fontWeight: 800, color: gold }}>entire families</Box>.</Typography>
              <H4Center color={navyText} mt={8}>Our<span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}> Core Focus</span></H4Center>
              <Divider sx={{ my: 2, borderColor: "rgba(255,255,255,0.1)" }} />
              <Typography color={navyText} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)',fontFamily: "'Playfair Display', serif" }}>&bull; <Box component="span" sx={{ fontWeight: 800, color: gold , fontFamily: "'Playfair Display', serif"}}>Supporting Mothers</Box> in the <Box component="span" sx={{ fontWeight: 600, color: olive }}>Third Trimester</Box>.<br />&bull; <Box component="span" sx={{ fontWeight: 800, color: navyText }}>Emergency Support</Box> for <Box component="span" sx={{ fontWeight: 800, color: gold }}>New Borns & NICU care</Box>.</Typography>
             <H4Center color={navyText} mt={8}>Compassion <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}> Beyond Boundaries </span></H4Center>
              <Divider sx={{ my: 2, borderColor: "rgba(255,255,255,0.1)" }} />
              <Typography color={navyText} lineHeight={1.8} sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)', fontFamily: "'Playfair Display', serif" }}>&bull; Children Striving <Box component="span" sx={{ color: gold, fontWeight: 800 ,fontFamily: "'Playfair Display', serif" }}>for education and sports excellence</Box>, and <Box component="span" sx={{ color: navyText, fontWeight: 700 }}>Injured elderly animals</Box>, <Box component="span" sx={{ color: gold, fontWeight: 800 }}>Mentally challenged elders facing neglect</Box>.</Typography>
              <H4Center color={navyText} mt={8}> Our <span style={{ color: olive, fontFamily: "'Playfair Display', serif", }}> Promise </span></H4Center>
              <Divider sx={{ my: 2, borderColor: gold }} />
              <Typography color={navyText} lineHeight={1.8} textAlign="center" fontSize="1.1rem" sx={{ textShadow: '1px 1px 2px rgba(0,0,0,0.8)', fontFamily: "'Playfair Display', serif" }}>&bull; We promise <Box component="span" sx={{ color: gold, fontWeight: 800 }}>presence</Box>, <Box component="span" sx={{ color: olive, fontWeight: 800 }}>honesty</Box>, and <Box component="span" sx={{ color: navyText, fontWeight: 800 }}>compassion</Box> to every life we reach.<br />&bull; Because <Box component="span" sx={{ color: gold, fontWeight: 900 }}>every life is worth fighting for</Box>.</Typography>
            </Box>
          </motion.div>
