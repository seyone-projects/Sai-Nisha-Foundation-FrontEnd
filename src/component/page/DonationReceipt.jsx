      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: "20px" }}>
            <label style={{ display: "block", color: "#0f172a", fontWeight: "700", fontSize: "13px", marginBottom: "8px", letterSpacing: "0.5px" }}>
              USERNAME
            </label>
            <input
              type="text"
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "50px",
              border: "none",
              background: "linear-gradient(to right, #08275d, #10b981)",
              color: "#fff",
              fontWeight: "800",
              fontSize: "16px",
              cursor: "pointer",
              letterSpacing: "0.5px",
              boxShadow: "0 6px 20px rgba(8,39,93,0.25)",
...
// ── Donation Receipt (original component) ────────────────────────────────────
const DonationReceipt = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-5">
      {/* Logout button */}
      <div style={{ textAlign: "right", maxWidth: "980px", margin: "0 auto 10px auto" }}>
        <button
          onClick={() => { setIsLoggedIn(false); setShowReceipt(false); }}
          style={{
            padding: "8px 22px",
            borderRadius: "50px",
            border: "none",
      ...
      >
        ...
        <button
          ...
          style={{ padding: "14px 35px", borderRadius: "50px", border: "none", background: "linear-gradient(to right,#2563eb,#10b981)", color: "#fff", fontWeight: "700", cursor: "pointer" }}
        >
          Generate Receipt
        </button>
