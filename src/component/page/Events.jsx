      ...
      <Box sx={{ minHeight: "100vh", display: "flex", flexDirection: "column", fontFamily: "Poppins, sans-serif" }}>
        ...
        <Container maxWidth="md" sx={{ zIndex: 3, mt: -5, mb: 10, textAlign: "center" }}>
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            ...
            On February 1, 2026, a meaningful “Birthday Tribute & Dream Reveal Ceremony” was held to honor the legacy and vision of the late Ganesh Shanmugam, Founder of Virtual India ALC Limited. The event took place at Jayanthi Narayanan Palace from 4 PM onwards and marked a significant step toward fulfilling his lifelong dreams and purpose.The occasion was graced by several distinguished guests, including spiritual leader Guru Roopa Yogi Sri La Sri Maha Narasimha Athmanatha Swamigal, legendary music director Dhina, film director R. Kannan, and actor Jagan Purushottam.The attendees also enjoyed special cultural performances by groups such as Team Gulab Events and Musica Cura, making the evening a memorable celebration of remembrance, inspiration, and the enduring legacy of the founder.
            </Typography>
          </motion.div>
        </Container>
