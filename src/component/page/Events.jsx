        ...
        <Container maxWidth="md" sx={{ zIndex: 3, mt: -5, mb: 10, textAlign: "center" }}>
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            ...
            <Typography sx={{ color: "rgba(255,255,255,0.7)", lineHeight: 1.8, fontSize: "1.1rem", textAlign: "justify", mx: "auto", px: 2 }}>
             On February 1, 2026, a meaningful “Birthday Tribute & Dream Reveal Ceremony” was successfully held in honor of the late Ganesh Shanmugam, Founder of Virtual India ALC Limited. The event took place at Jayanthi Narayanan Palace in East Tambaram, Chennai, from 4 PM onwards, bringing together supporters, well-wishers, and distinguished guests to remember and celebrate his inspiring legacy and vision. The occasion was attended by spiritual leader Guru Roopa Yogi Sri La Sri Maha Narasimha Athmanatha Swamigal, legendary music director Dhina, film director R. Kannan, and actor Jagan Purushottam. The evening also featured special cultural performances by Team Gulab Events and Musica Cura, making it a heartfelt gathering dedicated to honoring his life, dreams, and lasting impact.
            </Typography>
          </motion.div>
        </Container>
