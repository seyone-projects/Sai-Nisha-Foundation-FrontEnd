...
export default function Home() {
  ...
  const testimonials = [
    ...
    {
      text: "We strive to expand our reach by building strong and lasting partnerships with hospitals, doctors, and healthcare providers across underserved and rural regions. Through collaboration and trust, we aim to bridge gaps in access to care and bring life-saving support closer to those who need it the most.",
    },
    {
      text: "Our long-term vision is to create a sustainable and responsive support system where no family has to face pregnancy-related or newborn emergencies alone. By fostering community involvement, awareness, and continuous support, we work towards a future where every life is protected and valued.",
    },
  ];
    ...
    <ThemeProvider theme={theme}>
      ...
      <Box sx={{ position: "relative", backgroundColor: creamBg, overflowX: "hidden" }}>
        ...
        <Box
          sx={{
            py: 12,
            background: "linear-gradient(135deg, #e6ece3 0%, #f4f8f2 100%)",
          }}
        >
              ...
              >
                <Card
                  sx={{
                    ...
                    background: "linear-gradient(135deg, rgba(255, 255, 255, 0.9), rgba(238, 250, 243, 0.9))",
                    boxShadow: "0 25px 70px rgba(75, 110, 46, 0.25)",
                    position: "relative",
                    overflow: "hidden",
                  }}
                >
                  <Box
                    sx={{
                      position: "absolute",
                      inset: 0,
                      background: "radial-gradient(circle at top left, rgba(90,70,200,0.15), transparent 60%)",
                      pointerEvents: "none",
                    }}
                  />
                  <CardContent>
                      ...
                      >
                        <Box
                          ...
                          sx={{
                            color: "#2e6e3c",
                            fontWeight: 700,
                            background: "linear-gradient(120deg, #acc84666 0%, transparent 100%)",
                            px: 0.5,
                            borderRadius: 1,
                          }}
                        >
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              <motion.div variants={fadeLeft} initial="hidden" whileInView="visible">
                ...
                <Typography color={mutedText} lineHeight={2}>
                  ...
                  <br /><br />
                  • Supporting mothers{" "}
                  <span style={{ color: olive, fontWeight: 600 }}>when it matters most</span>
                  <br />
                  • The final weeks of pregnancy.{" "}
                  <span style={{ color: gold, fontWeight: 600 }}>their very first battle</span>
                  <br />
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              <motion.div variants={fadeRight} initial="hidden" whileInView="visible">
                ...
                <Typography color={mutedText} lineHeight={2}>
                  ...
                  <span style={{ color: olive, fontWeight: 600 }}>timely medical care</span>
                  <br />
                  • A newborn waits for{" "}
                  <span style={{ color: gold, fontWeight: 600 }}>life-saving NICU admission</span>
                  <br />
                  • Decisions are delayed — not due to lack of treatment, but lack of support
                  <br /><br />
                  In these moments, <strong style={{ color: navyText }}>even a small delay can change everything</strong>.
                </Typography>
              </motion.div>
            </Grid>
          </Grid>
            ...
            <Grid size={{ xs: 12, md: 7 }}>
              <motion.div variants={fadeLeft} initial="hidden" whileInView="visible">
                ...
                <Typography color={mutedText} lineHeight={2}>
                  Every day:
                  <br /><br />
                  • Supporting mothers <span style={{ color: olive, fontWeight: 600 }}>when it matters most</span>
                  <br />
                  • Helping newborns fight <span style={{ color: gold, fontWeight: 600 }}>their very first battle</span>
                  <br />
                  • Extending compassion to those often left unseen
                  <br /><br />
                  In these situation, <strong style={{ color: navyText }}>even a small portion can change everything</strong>.
                </Typography>
              </motion.div>
            </Grid>
            <Grid size={{ xs: 12, md: 5 }} sx={{ textAlign: { xs: "center", md: "right" } }}>
        ...
        >
          <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}>
            <Typography fontWeight={600} color="#1a1a1a">
              <span style={{ color: "#2E7D32" }}>From a child’s first breath…</span>{" "}
              <span style={{ color: "#efcb00" }}>to a family’s first relief…</span>
              <br />
              <strong style={{ color: "#2E7D32" }}>Sai Nisha Foundation stands beside life</strong>
              <span style={{ color: "#291905" }}>, when it needs support the most.</span>
            </Typography>
          </motion.div>
        </Box>
